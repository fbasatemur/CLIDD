...
if __name__ == '__main__':
    ...
    parser.add_argument('model', type=str, choices=CLIDD.cfgs.keys())
    ...
    model = CLIDD(args.model, top_k=args.top_k, radius=args.radius).eval()
    if torch.cuda.is_available():
        model = model.cuda()
    ...
    while 1:
        ...
        idxs1, idxs2 = model.match(frozen_desc, desc, args.beta)
